...
export function Sidebar() {
  ...
  return (
    <div className="flex h-screen w-64 flex-col bg-sidebar text-sidebar-foreground border-r border-sidebar-border">
      <div className="p-6">
        <h1 className="text-2xl font-bold font-heading text-white">Le Pingouin Studio</h1>
        <p className="text-sm text-sidebar-primary/80 mt-1 uppercase tracking-wider font-semibold">Admin Control</p>
      </div>
